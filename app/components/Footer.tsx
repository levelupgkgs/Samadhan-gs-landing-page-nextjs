...
const socialMedia = [
  ...
  {
    name: 'YouTube',
    url: 'https://www.youtube.com/@Samadhan_GS',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: 'Facebook',
    url: 'https://www.facebook.com/samadhangsexam',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          >
            ...
            <div className="space-y-2 text-sm text-gray-400">
              <div className="flex items-center gap-2">
                ...
                <a href="mailto:samadhangsexam@gmail.com" className="hover:text-blue-400 transition-colors">
            ...
            <div className="grid grid-cols-3 gap-3">
              {socialMedia.map((social, index) => (
                <motion.a
                  ...
                  className="flex flex-col items-center justify-center p-3 bg-white/5 hover:bg-white/10 rounded-xl transition-all group"
                ...
                >
                  ...
                  <span className="text-xs text-gray-500 mt-1 group-hover:text-gray-300 transition-colors">
                    {social.name}
                  </span>
                </motion.a>
              ))}
